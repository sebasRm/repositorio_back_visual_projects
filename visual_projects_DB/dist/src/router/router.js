...
router.post("/api/pocentaje/actividades/finalizadas", actividadController_1.porcentajeActividades);
...
router.post("/api/pocentaje/tareas/finalizadas", tareaController_1.porcentajeTareas);
